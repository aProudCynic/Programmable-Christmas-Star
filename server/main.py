...
@app.post("/start/different_colours")
async def different_colours(parameters: DifferentColourParameters):
    light_controller.start_loop_with_ttl(perform_different_colours, parameters)
